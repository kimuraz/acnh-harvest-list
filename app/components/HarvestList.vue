  ...
  <StackLayout>
    ...
    >
      <v-template>
        ...
        >
          <Label class="h3" :text="harvest" width="100%" />
          <Button
            text="-"
            class="red-bg"
            fontSize="20"
            ...
            width="18%"
          />
          <Label class="h3" :text="list[harvest].curAmount" width="15%" />
          <Button
            fontSize="20"
            text="+"
            class="blue-bg"
            ...
            width="18%"
          />
          <Label class="h3" text="of" width="8%" />
          <Label class="h3" :text="list[harvest].amount" width="15%" />
          <Button
            class="red-bg"
            text="Remove"
